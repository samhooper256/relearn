 ...
 *
 */
public class AudibleSet<E> implements Set<E>, ReadOnlyAudibleSet<E> {
	
	private final Set<E> set;
	private List<SingleListener<E>> addListeners, removeListeners;
	
	public AudibleSet(Supplier<Set<E>> factory) {
		set = factory.get();
	}
	...
	/** The listeners will be run after an element is added - that is, this {@link AudibleSet} will
